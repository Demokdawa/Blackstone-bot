...
async def halp(ctx):
    ...
    embed.add_field(name="!sendmeme", value="Envoie un dankmeme", inline=True)
    embed.add_field(name="!sendwfmeme", value="Envoie un meme Warframe", inline=True)
    embed.add_field(name="!sencursed", value="Envoie une image maudite", inline=True)
    embed.add_field(name="!sendyum", value="Envoie une image pour te donner faim", inline=True)
    embed.add_field(name="!sendearth", value="Envoie une magnifique image de mère nature", inline=True)
    embed.add_field(name="!sendnocontext", value="Envoie une image sans contexte", inline=True)
    embed.add_field(name="!sendwtf", value="Envoie une image WTF", inline=True)
    embed.add_field(name="!sendaww", value="Envoie des photos d'animaux mignons", inline=True)
    embed.add_field(name="!sendjojomeme", value="Attention aux spoilers !", inline=True)
    embed.add_field(name="!sendneko", value="Envoie des nekos toutes mimi !", inline=True)
    embed.add_field(name="!sendcreepy", value="Envoie des trucs bien creepy !", inline=True)
    embed.add_field(name="!sendtiming", value="Envoie de bons timings", inline=True)
    embed.add_field(name="!sendsfwporn", value="🔞", inline=True)
    embed.add_field(name="!sendyuri", value="🔞", inline=True)
    embed.add_field(name="!sendyurigif", value="🔞", inline=True)
    embed.add_field(name="!sendyurimeme", value="🔞", inline=True)
    embed.add_field(name="!sendnsfwarframe", value="🔞", inline=True)
    embed.add_field(name="!sendnekoh", value="🔞", inline=True)
    embed.add_field(name="!sendhh", value="🔞", inline=True)
    embed.add_field(name="!sendhart", value="🔞", inline=True)
    embed.add_field(name="!sendhhgif", value="🔞", inline=True)
    embed.add_field(name="!sendrule", value="🔞", inline=True)
    embed.add_field(name="!sendconfused", value="🔞", inline=True)
    embed.add_field(name="!sendecchi", value="🔞", inline=True)
    embed.add_field(name="!sendfurry", value="🔞", inline=True)
    embed.add_field(name="!sendhlol", value="🔞", inline=True)
    embed.add_field(name="!sendpokeh", value="🔞", inline=True)
    embed.add_field(name="!sendsoftyaoi", value="🔞", inline=True)
    embed.add_field(name="!sendhqh", value="🔞", inline=True)
    embed.add_field(name="!sendhfemdom", value="🔞", inline=True)
    embed.add_field(name="!sendhnwaifu", value="🔞", inline=True)
    embed.add_field(name="!send3dh", value="🔞", inline=True)
    embed.add_field(name="!sendwh", value="🔞", inline=True)
    embed.add_field(name="!sendhbooty", value="🔞", inline=True)
    embed.add_field(name="!sendthickh", value="🔞", inline=True)
